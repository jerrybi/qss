            ...
            if(result.status == 200){
                ...
                $.each(result.data,function (i,e) {
                    str_html +=
                        ...
                        "                <td class=\"title\">"+(e.location_group_name)+"</td>\n" +
                        "                <td class=\"title\">"+e.event_name+"</td>\n" +
                        "                <td>"+e.list_order +"</td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"layui-btn-group\">\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Edit location groups' \n" +
                        "                                onclick=\"editForOpenPopups('✎ Edit location groups','"+e.id+"','','76%')\">\n" +
                        "                            <i class=\"layui-icon\">&#xe642;</i>\n" +
                        "                        </button>\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Remove location groups' \n" +
