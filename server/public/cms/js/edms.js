            ...
            if(result.status == 200){
                ...
                $.each(result.data,function (i,e) {
                    str_html +=
                        ...
                        "                <td class=\"title\">"+e.content+"</td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"layui-btn-group\">\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Edit ems' \n" +
                        "                                onclick=\"editForOpenPopups('✎ Edit ems','"+e.id+"','720px','95%')\">\n" +
                        "                            <i class=\"layui-icon\">&#xe642;</i>\n" +
                        "                        </button>\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Remove ems' \n" +
