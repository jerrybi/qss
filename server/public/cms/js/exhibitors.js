            ...
            if(result.status == 200){
                ...
                $.each(result.data,function (i,e) {
                    str_html +=
                        ...
                        "                <td>"+e.mobile +"</td>\n" +
                        "                <td>"+e.brochure_num +"</td>\n" +
                        "                <td>\n" +
                        "                    <div class=\"layui-btn-group\">\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Edit event' \n" +
                        "                                onclick=\"editForOpenPopups('✎ Edit exhibitor','"+e.unique_id+"','720px','420px')\">\n" +
                        "                            <i class=\"layui-icon\">&#xe642;</i>\n" +
                        "                        </button>\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title=\"Manage brochures\"\n" +
                    "                            onclick=\"manageForOpenPopups('✎ Manage brochures','{$vo.id}', '720px', '460px')\">\n" +
                    "                                   <i class=\"layui-icon\">&#xe62f;</i>\n" +
                    "                               </button>\n" +
