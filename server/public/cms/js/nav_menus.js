            ...
            if(result.status == 200){
                ...
                $.each(result.data,function (i,e) {
                    ...
                    str_html +=
                        ...
                        "                <td class=\"icon\"><i class='layui-circle "+e.icon+"'></td>\n" +
                        "                <td>"+e.action+"</td>\n" +
                        ...
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Edit menu' \n" +
                        "                                onclick=\"editForOpenPopups('✎ Edit menu','"+e.id+"', '66%', '88%')\">\n" +
                        "                            <i class=\"layui-icon\">&#xe642;</i>\n" +
                        "                        </button>\n" +
                        "                        <button class=\"layui-btn layui-btn-sm\" title='Delete menu' \n" +
                        ...
                        // if(parentID>0){
                        str_html+=
                            "                        <button class=\"layui-btn layui-btn-sm\" title='Auth list' \n" +
