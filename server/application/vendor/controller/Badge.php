...
class Badge extends UserBase
{
    ...
    public function index(Request $request){
        ...
        if ($request->isPost()) {
            $articles = $this->badgeModel->getVendorReportForPage($this->userInfo['event_id'],$formId,$curr_page, $limit);
            $record_num = $this->badgeModel->getVendorReportCount($this->userInfo['event_id'],$formId);
            $data = [
                'articles' => $articles,
